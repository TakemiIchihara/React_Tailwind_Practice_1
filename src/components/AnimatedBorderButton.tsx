...
type AnimatedBorderButtonType = {
  children: React.ReactNode,
}
export const AnimatedBorderButton = ( { children }: AnimatedBorderButtonType ) => {
  return (
    <button 
    ...
    >
      ...
      >
        <path
          d='M30,1 A 29,29 0 0 0 1,30 L 1,30 A 29,29 0 0 0 30,59 L 170,59 A'
          fill='none'
