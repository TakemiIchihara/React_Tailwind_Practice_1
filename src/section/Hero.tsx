          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground max-w-lg animate-fade-in animation-delay-200">
                Hi, I'm Takemi Ichihara - a software engineer specializing in React, Next.js, and TypeScript. I build scalable, performant web applications that users love.
              </p>
            </div>
            ...
            <div className="relative max-w-md mx-auto">
              ...
              <div className="relative glass rounded-3xl p-1 glow-border">
                ...
                <div className="absolute -top-4 -left-4 glass rounded-xl px-4 py-3 animate-float animation-delay-500">
                  <span className="text-xl block font-bold text-primary">5+</span>
                  <span className="text-xs block text-muted-background">Years Exp.</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden">
            <div className="flex animate-marquee">
              {[...skills, ...skills].map((skill, idx) => (
                <div key={idx} className="flex-shrink-0 px-8 py-4 "><span className="text-xl font-semibold text-muted-foreground/50 hover:text-muted-foreground transition-colors">{skill}</span></div>
              ))}
            </div>
          </div>
        </div>
